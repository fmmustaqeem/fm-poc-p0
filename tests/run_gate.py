...
TESTS = [ROOT/"tests"/f"test_{i:02d}_" + name for i,name in enumerate(["normal_run.py","missing_column.py","wrong_type.py","duplicate_file.py","corrupted_file.py","retry.py","reproducibility.py","audit.py","dry_run.py"],1)]
